...
export default function Community() {
  ...
  const numDays =
    parseInt(dayjs(dateValue.endDate).format("DD/MM/YYYY")) -
    parseInt(dayjs(dateValue.startDate).format("DD/MM/YYYY"));
    ...
    post
      ...
      .map((item, idx) => {
        return (
          <div
            key={idx}
            style={{ backgroundColor: "", width: "100%", padding: "5px" }}
          >
            <div
            ...
            >
              ...
              >
                ...
                >
                  created 📍 <b>{item.title}</b> with{" "}
                  <b>{item.data.length + " locations innit "}</b>{" "}
                  {" on " + dayjs(item.created_at).format("DD-MMM-YY")}
                </div>
              </div>
              <div
                style={{
              ...
              >
                <MarkerMap
                  mapSize={{ width: "30vw", height: "30vh" }}
                  mapData={{ selected: item, type: "POST" }}
                />
              </div>
            </div>
          </div>
  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        background: 'url("https://i.redd.it/10e6ttd0fp4d1.jpeg")',
        backgroundSize: "cover",
        overflowY: "scroll",
      }}
    >
      <div style={{ padding: "40px" }}>
        <b style={{ color: "white", fontSize: "50px" }}>
          Explore Our Community{" "}
        </b>
      </div>
      <div className="divider" style={{ color: "white", borderColor: "white" }}>
        OR
      </div>
      {createDisplay && (
